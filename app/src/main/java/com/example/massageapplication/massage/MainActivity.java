...
//            requestDefaultSmsApp();
    ...
    private void updateToolBar(Boolean isSearchActive) {
        ...
        if (isSearchActive) {
           ...
           /* b.title.setVisibility(View.GONE);
            b.layoutAll.setVisibility(View.GONE);
            b.cvDrawer.setVisibility(View.GONE);*/
        } else {
            b.llSearch.setVisibility(View.GONE);
            b.imgMainClose.setVisibility(View.GONE);
           /* b.title.setVisibility(View.VISIBLE);
            b.layoutAll.setVisibility(View.VISIBLE);
            b.cvDrawer.setVisibility(View.VISIBLE);*/
        }
    ...
    private void loadMessages() {
        ...
        new Thread(() -> {
            ...
            // Update the main list in a synchronized block
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                diffResult.dispatchUpdatesTo(smsAdapter);  // Notify the adapter
            });
        }).start();
    }
